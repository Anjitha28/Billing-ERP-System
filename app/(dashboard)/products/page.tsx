    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Manage products and services used for billing and invoicing.</p>
        </div>
        <Link
          href="/products/new"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">{activeItems}</p>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
          ...
          <p className="mt-2 text-2xl font-bold text-gray-900">{totalServices}</p>
        </div>
      </div>
