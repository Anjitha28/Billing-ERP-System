    ...
    <div className="space-y-6 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
          <h3 className="text-sm font-medium text-gray-500 uppercase">Paid Revenue</h3>
          <p className="mt-2 text-3xl font-bold text-gray-900">₹{paidRevenue.toFixed(2)}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-orange-500">
          <h3 className="text-sm font-medium text-gray-500 uppercase">Outstanding Receivables</h3>
          <p className="mt-2 text-3xl font-bold text-gray-900">₹{unpaidRevenue.toFixed(2)}</p>
        </div>
      </div>
